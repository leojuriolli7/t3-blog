...
export const env = createEnv({
  ...
  client: {
    NEXT_PUBLIC_BYPASS_URL: z.string(),
    ...
    NEXT_PUBLIC_UPLOAD_MAX_FILE_SIZE: z.string(),
    NEXT_PUBLIC_UPLOADING_TIME_LIMIT: z.string(),
    NEXT_PUBLIC_UPLOAD_MAX_NUMBER_OF_FILES: z.string(),
  },
  runtimeEnv: {
